...
class InitialTableViewController: UITableViewController, MPMediaPickerControllerDelegate {
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if (segue.identifier == "showMediaItem") {
            let mediaItemTableViewController: MediaItemTableViewController =
                segue.destinationViewController as! MediaItemTableViewController
            let selectedIndexPath: NSIndexPath = self.tableView.indexPathForSelectedRow!

            mediaItemTableViewController.mediaItem = mediaItems[selectedIndexPath.row]
        }
    }
